...
-libraryjars '<user.home>/.m2/repository/org/fusesource/jansi/jansi/2.3.2/jansi-2.3.2.jar'
...
-libraryjars '<user.home>/.m2/repository/com/github/spotbugs/spotbugs-annotations/4.4.0/spotbugs-annotations-4.4.0.jar'
