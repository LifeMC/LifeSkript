 ...
 */
public final class SkriptAPIException extends RuntimeException {
    ...
    public static final void inaccessibleConstructor(final Class<?> c, final IllegalAccessException e) throws SkriptAPIException {
        throw new SkriptAPIException("The constructor of " + c.getName() + " and/or the class itself is/are not public", e);
    }

    public static final void instantiationException(final Class<?> c, final InstantiationException e) throws SkriptAPIException {
