...
public final class DefaultFunctions {
	...
	static {
		...
		}.description("The exponential function. You probably don't need this if you don't know what this is.").examples("exp(0) = 1", "exp(1) = " + s(Math.exp(1))).since("2.2"));
		...
		}.description("The sine function. It starts at 0° with a value of 0, goes to 1 at 90°, back to 0 at 180°, to -1 at 270° and then repeats every 360°. Uses degrees, not radians.").examples("sin(90) = 1", "sin(60) = " + s(Math.sin(Math.toRadians(60)))).since("2.2"));
		...
		}.description("The tangent function. This is basically <code><a href='#sin'>sin</a>(arg)/<a href='#cos'>cos</a>(arg)</code>. Uses degrees, not radians.").examples("tan(0) = 0", "tan(45) = 1", "tan(89.99) = " + s(Math.tan(Math.toRadians(89.99)))).since("2.2"));
		...
		}.description("The inverse of the <a href='#sin'>sine</a>, also called arcsin. Returns result in degrees, not radians. Only returns values from -90 to 90.").examples("asin(0) = 0", "asin(1) = 90", "asin(0.5) = " + s(Math.toDegrees(Math.asin(0.5)))).since("2.2"));
		...
		}.description("The inverse of the <a href='#cos'>cosine</a>, also called arccos. Returns result in degrees, not radians. Only returns values from 0 to 180.").examples("acos(0) = 90", "acos(1) = 0", "acos(0.5) = " + s(Math.toDegrees(Math.asin(0.5)))).since("2.2"));
		...
		Functions.registerFunction(new JavaFunction<Location>("location", new Parameter[] {new Parameter<Number>("x", numberClass, true, null), new Parameter<Number>("y", numberClass, true, null), new Parameter<Number>("z", numberClass, true, null), new Parameter<World>("world", Classes.getExactClassInfo(World.class), true, new EventValueExpression<World>(World.class)), new Parameter<Number>("yaw", numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<Number>("pitch", numberClass, true, new SimpleLiteral<Number>(0, true))
		}, Classes.getExactClassInfo(Location.class), true) {
			@Override
			public Location[] execute(final FunctionEvent e, final Object[][] params) {
				return new Location[] {new Location((World) params[3][0], ((Number) params[0][0]).doubleValue(), ((Number) params[1][0]).doubleValue(), ((Number) params[2][0]).doubleValue(), ((Number) params[4][0]).floatValue(), ((Number) params[5][0]).floatValue())};
			}
		...
		Functions.registerFunction(new JavaFunction<Date>("date", new Parameter[] {new Parameter<Number>("year", numberClass, true, null), new Parameter<Number>("month", numberClass, true, null), new Parameter<Number>("day", numberClass, true, null), new Parameter<Number>("hour", numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<Number>("minute", numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<Number>("second", numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<Number>("millisecond", numberClass, true, new SimpleLiteral<Number>(0, true)), new Parameter<Number>("zone_offset", numberClass, true, new SimpleLiteral<Number>(Double.NaN, true)), new Parameter<Number>("dst_offset", numberClass, true, new SimpleLiteral<Number>(Double.NaN, true)),
			...
			private final double[] relations = {1. / 12, 1. / 30, 1. / 24, 1. / 60, 1. / 60, 1. / 1000, 0, 0, 0};
			{
